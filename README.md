# Momentum Image Viewer

momentum is a high-performance image viewer written in Rust, designed for speed and simplicity. It supports standard image formats (JPEG, PNG) as well as RAW formats (NEF, CR2, DNG, ARW).
